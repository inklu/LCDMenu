...
MyMenu m;
byte clkPin=9,dtPin=10,swPin=8;
MenuEncoderController mec(clkPin,dtPin,swPin);
...
void loop() {
  ...
  mec.run(); //длительное нажатие на OK автивирует меню, длительное нажатие на BACK деактивирует меню
